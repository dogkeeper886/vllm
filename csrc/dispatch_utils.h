...
// Float8 dispatch macros — require PyTorch 2.1+ (Float8 types).
// Guarded for legacy CUDA builds targeting PyTorch 2.0.x.
#ifndef VLLM_BUILD_LEGACY_CUDA
...
// PyTorch 2.0.x lacks UInt16/UInt32/UInt64 ScalarType members.
